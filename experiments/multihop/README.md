...
## Run
```
python multihop_task.py     # verify the task (numpy only)
python certificates.py      # training-free wall/way-out analysis (numpy+scipy)
python run_multihop.py      # train + eval, hop-by-hop accuracy (needs torch + GPU)
```
