...
# pool_sequence moved to koopman_lm/pooling.py: KoopmanLM.encode needs it, and
# having the model core import from this research package was the only edge in
# the repo pointing core -> periphery. Re-exported here so existing imports
# (code-tests/test_retrieval_encoder.py, any downstream caller) keep working.
from koopman_lm.pooling import pool_sequence  # noqa: F401
