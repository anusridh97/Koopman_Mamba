...
# _param_groups moved to experimentation.training.optim.param_groups (imported
...
def train(args):
    ...
    if (args.diag_enable and is_main
        ...
        from experimentation.training.diagnostics import SKAHealthMonitor, GradFlowMonitor
        try:
