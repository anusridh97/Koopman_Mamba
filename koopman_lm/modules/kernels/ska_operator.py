"""
ska_operator.py -- the whitened SKA operator (PyTorch port of echo_jax.py's core).
...
The small linear-algebra primitives it composes (triangular solves, double-sided
whitening, detached spectral norm, Newton-Schulz inverse sqrt) live in lin_alg.py
-- they are reused by the recurrent decode path and factor_scan, so they are not
SKA-specific and don't belong inside this operator file.
"""

import torch

from koopman_lm.modules.kernels.lin_alg import (
