...
class Mamba2Block(nn.Module):
    """Wrapper for Mamba-2 layer. Requires mamba_ssm."""
...
class KoopmanLM(nn.Module):
    ...
    def attach_last_layer_memory(self, rank=64, ridge=1e-2, gate_init=1e-2,
        ...
        """
        from koopman_lm.last_layer_memory import LastLayerRidgeMemory
    ...
    def forward_with_memory(self, input_ids, token_weights=None,
        ...
        if token_weights is None:
            if prompt_len is not None:
                from koopman_lm.last_layer_memory import make_memory_token_weights
